...
!function(t, e) {
    ...
    n.LINEAR = function(t) {
        ...
        if (this.parentEl = r, n && n.file) {
            ...
            i.setAttribute("type", "image/svg+xml"), i.setAttribute("data", n.file), i.setAttribute("width", "100%"), i.setAttribute("height", "100%"), r.appendChild(i), r = i
        }
        ...
        case t.HTMLObjectElement:
            if (this.el = r.contentDocument && r.contentDocument.querySelector("svg"), this.el)
                return this.isReady=!0, void 0;
            var a = this;
            r.addEventListener("load", function() {
                if (a.el = r.contentDocument && r.contentDocument.querySelector("svg"), !a.el)
        ...
        var r = ["delayed", "async", "oneByOne", "scenario", "scenario-sync"], i = ["inViewport", "manual", "autostart"];
